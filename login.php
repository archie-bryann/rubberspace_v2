<?php
  ...
  <br>
    ...
    <legend><h2 align = "center">Log in to <?php echo name; ?></h2></legend><br>
        <div class = "jumbotron">
...
if(isset($_POST['submit'])){
    ...
    if(hash_equals($_SESSION['token'], $_POST['token'])) {
                ...
                <button type="button" class="close" data-dismiss="alert">&times;</button><i class = "material-icons left">error</i> '.
...
<br>
      <button name = "submit" type="submit" class="btn <?php echo button1;  ?> btn-lg btn-block">Log in</button>
</form>
