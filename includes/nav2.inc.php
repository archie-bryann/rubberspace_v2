<button class="navbar-toggler collapsed animated rubberBand" type="button" data-toggle="collapse" data-target="#navbarColor01" aria-controls="navbarColor01" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="navbar-collapse collapse" id="navbarColor01" style="">
    ...
    ?>
      ...
      <li class="nav-item <?php if(strpos($url, 'uploads')) { echo 'active'; } ?>">
        <a class="nav-link" href="<?php echo ROOT_URL.'uploads';?>">My Uploads</a>
      </li>
      <li class="nav-item <?php if(strpos($url, 'profile.php')) { echo 'active'; } ?>">
        <a class="nav-link" href="<?php echo ROOT_URL.'profile';?>">Edit Profile</a>
      </li>
